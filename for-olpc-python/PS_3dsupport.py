...
class KfPoint3D(object):
    ...
    def addXYZ(self, xOffset, yOffset, zOffset):
        self.x += xOffset
        self.y += yOffset
        self.z += zOffset
...
class KfTriangle(object):
    ...
    def drawLinesColor(self, lineContrastIndex):
        ...
        if lineContrastIndex > 0:
            result = PS_support.darkerColorWithSubtraction(result, 10 * lineContrastIndex)
        return result
