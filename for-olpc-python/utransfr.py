...
''' This file holds the parameters used by plants.
'''
...
#m broken into two parts - presumably for size..
#m but what's it doing ?
def Plant_directTransferField(plantProxy, v, d, fieldID, ft, index, updateList):
    '''
        - ft is fieldtype and used to prevent copying headers and 3dobjects
        - d = direction of transfer
        - index used only if scurve
        - updatelist unused
    '''
    if plantProxy == None:
        raise GeneralException.create("Plant_directTransferField: nil plant")
    plant = plantProxy
    print "direct transfer", fieldID
    if fieldID == kGeneralLineDivisions:
        # if d = kGetField then copy lineDivisions into v
        # else copy v into lineDivisions
...
## Theory fail - try just removing the leading thingy  and leave v in ?
...
##        # if d = kGetField then copy lineDivisions into v
##        # else copy v into lineDivisions
##        plant.MFD(plant.pGeneral.lineDivisions, v, ft, d)
##    elif fieldID == kGeneralRandomSway:
##        plant.MFD(plant.pGeneral.randomSway, v, ft, d)
##    elif fieldID == kGeneralAgeAtMaturity:
##        plant.MFD(plant.pGeneral.ageAtMaturity, v, ft, d)
##    elif fieldID == kGeneralGrowthSCurve:
##        umath.transferSCurveValue(d, plant.pGeneral.growthSCurve, index, v)
##    elif fieldID == kGeneralAgeAtWhichFloweringStarts:
##        plant.MFD(plant.pGeneral.ageAtWhichFloweringStarts, v, ft, d)
##    elif fieldID == kGeneralFractionReproductiveAllocationAtMaturity:
##        plant.MFD(plant.pGeneral.fractionReproductiveAllocationAtMaturity_frn, v, ft, d)
##    elif fieldID == kGeneralMaleFlowersAreSeparate:
##        plant.MFD(plant.pGeneral.maleFlowersAreSeparate, v, ft, d)
##    elif fieldID == kGeneralIsDicot:
##        plant.MFD(plant.pGeneral.isDicot, v, ft, d)
##    elif fieldID == kGeneralNumApicalInflors:
##        plant.MFD(plant.pGeneral.numApicalInflors, v, ft, d)
##    elif fieldID == kGeneralNumAxillaryInflors:
##        plant.MFD(plant.pGeneral.numAxillaryInflors, v, ft, d)
##    elif fieldID == kGeneralPhyllotacticRotationAngle:
##        plant.MFD(plant.pGeneral.phyllotacticRotationAngle, v, ft, d)
##    elif fieldID == kGeneralStartingSeedForRandomNumberGenerator:
##        plant.MFD(plant.pGeneral.startingSeedForRandomNumberGenerator, v, ft, d)
##    elif fieldID == kMeristemAndLeafArrangement:
##        plant.MFD(plant.pMeristem.branchingAndLeafArrangement, v, ft, d)
##    elif fieldID == kMeristemBranchingIndex:
##        plant.MFD(plant.pMeristem.branchingIndex, v, ft, d)
##    elif fieldID == kMeristemBranchingDistance:
##        plant.MFD(plant.pMeristem.branchingDistance, v, ft, d)
##    elif fieldID == kMeristemSecondaryBranchingIsAllowed:
##        plant.MFD(plant.pMeristem.secondaryBranchingIsAllowed, v, ft, d)
##    elif fieldID == kMeristemBranchingIsSympodial:
##        plant.MFD(plant.pMeristem.branchingIsSympodial, v, ft, d)
##    elif fieldID == kMeristemBranchingAngle:
##        plant.MFD(plant.pMeristem.branchingAngle, v, ft, d)
##    elif fieldID == kMeristemDeterminateProbability:
##        plant.MFD(plant.pMeristem.determinateProbability, v, ft, d)
##    elif fieldID == kAxillaryBudObject3D:
##        plant.transferObject3D(d, plant.pAxillaryBud.tdoParams.object3D, v)
##    elif fieldID == kAxillaryBudScale:
##        plant.MFD(plant.pAxillaryBud.tdoParams.scaleAtFullSize, v, ft, d)
##    elif fieldID == kAxillaryBudObject3DXRotationBeforeDraw:
##        plant.MFD(plant.pAxillaryBud.tdoParams.xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kAxillaryBudObject3DYRotationBeforeDraw:
##        plant.MFD(plant.pAxillaryBud.tdoParams.yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kAxillaryBudObject3DZRotationBeforeDraw:
##        plant.MFD(plant.pAxillaryBud.tdoParams.zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kAxillaryBudFaceColor:
##        plant.MFD(plant.pAxillaryBud.tdoParams.faceColor, v, ft, d)
##    elif fieldID == kAxillaryBudBackfaceColor:
##        plant.MFD(plant.pAxillaryBud.tdoParams.backfaceColor, v, ft, d)
##    elif fieldID == kInternodeFaceColor:
##        plant.MFD(plant.pInternode.faceColor, v, ft, d)
##    elif fieldID == kInternodeFirstInternodeCurvingIndex:
##        plant.MFD(plant.pInternode.firstInternodeCurvingIndex, v, ft, d)
##    elif fieldID == kInternodeCurvingIndex:
##        plant.MFD(plant.pInternode.curvingIndex, v, ft, d)
##    elif fieldID == kInternodeLengthAtOptimalFinalBiomassAndExpansion_mm:
##        plant.MFD(plant.pInternode.lengthAtOptimalFinalBiomassAndExpansion_mm, v, ft, d)
##    elif fieldID == kInternodeWidthAtOptimalFinalBiomassAndExpansion_mm:
##        plant.MFD(plant.pInternode.widthAtOptimalFinalBiomassAndExpansion_mm, v, ft, d)
##    elif fieldID == kInternodeOptimalFinalBiomass:
##        plant.MFD(plant.pInternode.optimalFinalBiomass_pctMPB, v, ft, d)
##    elif fieldID == kInternodeMinDaysToCreateInternode:
##        plant.MFD(plant.pInternode.minDaysToCreateInternode, v, ft, d)
##    elif fieldID == kInternodeMaxDaysToCreateInternodeIfOverMinFraction:
##        plant.MFD(plant.pInternode.maxDaysToCreateInternodeIfOverMinFraction, v, ft, d)
##    elif fieldID == kInternodeMinFractionOfOptimalInitialBiomassToCreateInternode_frn:
##        plant.MFD(plant.pInternode.minFractionOfOptimalInitialBiomassToCreateInternode_frn, v, ft, d)
##    elif fieldID == kInternodeCanRecoverFromStuntingDuringCreation:
##        plant.MFD(plant.pInternode.canRecoverFromStuntingDuringCreation, v, ft, d)
##    elif fieldID == kInternodeMinDaysToAccumulateBiomass:
##        plant.MFD(plant.pInternode.minDaysToAccumulateBiomass, v, ft, d)
##    elif fieldID == kInternodeMaxDaysToAccumulateBiomass:
##        plant.MFD(plant.pInternode.maxDaysToAccumulateBiomass, v, ft, d)
##    elif fieldID == kInternodeLengthMultiplierDueToBolting:
##        plant.MFD(plant.pInternode.lengthMultiplierDueToBolting, v, ft, d)
##    elif fieldID == kInternodeBoltingMinDaysToBolt:
##        plant.MFD(plant.pInternode.minDaysToBolt, v, ft, d)
##    elif fieldID == kLeafObject3D:
##        plant.transferObject3D(d, plant.pLeaf.leafTdoParams.object3D, v)
##    elif fieldID == kLeafScaleAtOptimalBiomass:
##        plant.MFD(plant.pLeaf.leafTdoParams.scaleAtFullSize, v, ft, d)
##    elif fieldID == kLeafObject3DXRotationBeforeDraw:
##        plant.MFD(plant.pLeaf.leafTdoParams.xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kLeafObject3DYRotationBeforeDraw:
##        plant.MFD(plant.pLeaf.leafTdoParams.yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kLeafObject3DZRotationBeforeDraw:
##        plant.MFD(plant.pLeaf.leafTdoParams.zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kLeafFaceColor:
##        plant.MFD(plant.pLeaf.leafTdoParams.faceColor, v, ft, d)
##    elif fieldID == kLeafBackfaceColor:
##        plant.MFD(plant.pLeaf.leafTdoParams.backfaceColor, v, ft, d)
##    elif fieldID == kLeafCompoundNumLeaflets:
##        plant.MFD(plant.pLeaf.compoundNumLeaflets, v, ft, d)
##    elif fieldID == kLeafCompoundPinnateOrPalmate:
##        plant.MFD(plant.pLeaf.compoundPinnateOrPalmate, v, ft, d)
##    elif fieldID == kLeafCompoundPinnateArrangement:
##        plant.MFD(plant.pLeaf.compoundPinnateLeafletArrangement, v, ft, d)
##    elif fieldID == kLeafCompoundRachisToPetioleRatio:
##        plant.MFD(plant.pLeaf.compoundRachisToPetioleRatio, v, ft, d)
##    elif fieldID == kLeafCompoundBendAngleAtStart:
##        plant.MFD(plant.pLeaf.compoundCurveAngleAtStart, v, ft, d)
##    elif fieldID == kLeafCompoundBendAngleAtFullSize:
##        plant.MFD(plant.pLeaf.compoundCurveAngleAtFullSize, v, ft, d)
##    elif fieldID == kLeafPetioleAngle:
##        plant.MFD(plant.pLeaf.petioleAngle, v, ft, d)
##    elif fieldID == kLeafPetioleColor:
##        plant.MFD(plant.pLeaf.petioleColor, v, ft, d)
##    elif fieldID == kLeafPetioleLengthAtOptimalBiomass_mm:
##        plant.MFD(plant.pLeaf.petioleLengthAtOptimalBiomass_mm, v, ft, d)
##    elif fieldID == kLeafPetioleWidthAtOptimalBiomass_mm:
##        plant.MFD(plant.pLeaf.petioleWidthAtOptimalBiomass_mm, v, ft, d)
##    elif fieldID == kLeafPetioleTaperIndex:
##        plant.MFD(plant.pLeaf.petioleTaperIndex, v, ft, d)
##    elif fieldID == kStipuleNumSections:
##        plant.MFD(plant.pLeaf.stipuleTdoParams.repetitions, v, ft, d)
##    elif fieldID == kStipuleObject3D:
##        plant.transferObject3D(d, plant.pLeaf.stipuleTdoParams.object3D, v)
##    elif fieldID == kStipuleScaleAtOptimalLeafBiomass:
##        plant.MFD(plant.pLeaf.stipuleTdoParams.scaleAtFullSize, v, ft, d)
##    elif fieldID == kStipuleObject3DXRotationBeforeDraw:
##        plant.MFD(plant.pLeaf.stipuleTdoParams.xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kStipuleObject3DYRotationBeforeDraw:
##        plant.MFD(plant.pLeaf.stipuleTdoParams.yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kStipuleObject3DZRotationBeforeDraw:
##        plant.MFD(plant.pLeaf.stipuleTdoParams.zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kStipuleFaceColor:
##        plant.MFD(plant.pLeaf.stipuleTdoParams.faceColor, v, ft, d)
##    elif fieldID == kStipuleBackfaceColor:
##        plant.MFD(plant.pLeaf.stipuleTdoParams.backfaceColor, v, ft, d)
##    elif fieldID == kStipuleAngleFromStem:
##        plant.MFD(plant.pLeaf.stipuleTdoParams.pullBackAngle, v, ft, d)
##    elif fieldID == kLeafOptimalBiomass:
##        plant.MFD(plant.pLeaf.optimalBiomass_pctMPB, v, ft, d)
##    elif fieldID == kLeafSCurve:
##        umath.transferSCurveValue(d, plant.pLeaf.sCurveParams, index, v)
##    elif fieldID == kLeafOptimalFractionOfOptimalBiomassAtCreation_frn:
##        plant.MFD(plant.pLeaf.optimalFractionOfOptimalBiomassAtCreation_frn, v, ft, d)
##    elif fieldID == kLeafMinDaysToGrow:
##        plant.MFD(plant.pLeaf.minDaysToGrow, v, ft, d)
##    elif fieldID == kLeafMaxDaysToGrow:
##        plant.MFD(plant.pLeaf.maxDaysToGrow, v, ft, d)
##    elif fieldID == kSeedlingLeafObject3D:
##        plant.transferObject3D(d, plant.pSeedlingLeaf.leafTdoParams.object3D, v)
##    elif fieldID == kSeedlingLeafScale:
##        plant.MFD(plant.pSeedlingLeaf.leafTdoParams.scaleAtFullSize, v, ft, d)
##    elif fieldID == kSeedlingLeafObject3DXRotationBeforeDraw:
##        plant.MFD(plant.pSeedlingLeaf.leafTdoParams.xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kSeedlingLeafObject3DYRotationBeforeDraw:
##        plant.MFD(plant.pSeedlingLeaf.leafTdoParams.yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kSeedlingLeafObject3DZRotationBeforeDraw:
##        plant.MFD(plant.pSeedlingLeaf.leafTdoParams.zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kSeedlingLeafFaceColor:
##        plant.MFD(plant.pSeedlingLeaf.leafTdoParams.faceColor, v, ft, d)
##    elif fieldID == kSeedlingLeafBackfaceColor:
##        plant.MFD(plant.pSeedlingLeaf.leafTdoParams.backfaceColor, v, ft, d)
##    elif fieldID == kSeedlingLeafNodesOnStemWhenFallsOff:
##        plant.MFD(plant.pSeedlingLeaf.nodesOnStemWhenFallsOff, v, ft, d)
##    elif fieldID == kFlowerNumPetalsFemale:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFirstPetals].repetitions, v, ft, d)
##    elif fieldID == kFlowerFemaleObject3D:
##        plant.transferObject3D(d, plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFirstPetals].object3D, v)
##    elif fieldID == kFlowerScaleAtFullSizeFemale:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFirstPetals].scaleAtFullSize, v, ft, d)
##    elif fieldID == kFlowerFemaleObject3DXRotationBeforeDraw:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFirstPetals].xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemaleObject3DYRotationBeforeDraw:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFirstPetals].yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemaleObject3DZRotationBeforeDraw:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFirstPetals].zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemaleFaceColor:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFirstPetals].faceColor, v, ft, d)
##    elif fieldID == kFlowerFemaleBackfaceColor:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFirstPetals].backfaceColor, v, ft, d)
##    elif fieldID == kFlowerPetalsAreRadiallyArrangedFemale:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFirstPetals].radiallyArranged, v, ft, d)
##    elif fieldID == kFlowerFemaleObject3DPullbackAngle:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFirstPetals].pullBackAngle, v, ft, d)
##    elif fieldID == kFlowerOptimalBiomassFemale:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].optimalBiomass_pctMPB, v, ft, d)
##    elif fieldID == kFlowerMinFractOptBiomassToOpenFlowerFemale:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].minFractionOfOptimalBiomassToOpenFlower_frn, v, ft, d)
##    elif fieldID == kFlowerMinFractionOfOptimalBiomassToCreateFruitFemale:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].minFractionOfOptimalBiomassToCreateFruit_frn, v, ft, d)
##    elif fieldID == kFlowerMinDaysToGrowFemale:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].minDaysToGrow, v, ft, d)
##    elif fieldID == kFlowerMaxDaysToGrowIfOverMinFractionFemale:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].maxDaysToGrowIfOverMinFraction, v, ft, d)
##    elif fieldID == kFlowerMinDaysBeforeOpeningFemale:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].minDaysToOpenFlower, v, ft, d)
##    elif fieldID == kFlowerMinDaysBeforeSettingFruit:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].minDaysBeforeSettingFruit, v, ft, d)
##    elif fieldID == kFlowerDaysBeforeDropFemale:
##        plant.MFD(plant.pFlower[uplant.kGenderFemale].daysBeforeDrop, v, ft, d)
##    elif fieldID == kInflorescenceNumFlowersOnMainBranchFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].numFlowersOnMainBranch, v, ft, d)
##    elif fieldID == kInflorescenceNumFlowersPerBranchFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].numFlowersPerBranch, v, ft, d)
##    elif fieldID == kInflorescenceNumBranchesFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].numBranches, v, ft, d)
##    elif fieldID == kInflorescenceFemaleStalkColor:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].stalkColor, v, ft, d)
##    elif fieldID == kInflorescenceFemalePedicelColor:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].pedicelColor, v, ft, d)
##    elif fieldID == kInflorescenceBranchesAreAlternateFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].branchesAreAlternate, v, ft, d)
##    elif fieldID == kInflorescenceBranchAngleFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].branchAngle, v, ft, d)
##    elif fieldID == kInflorescenceInternodeAngleFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].angleBetweenInternodes, v, ft, d)
##    elif fieldID == kInflorescencePedicelAngleFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].pedicelAngle, v, ft, d)
##    elif fieldID == kInflorescencePeduncleAngleFromVegetativeStemFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].peduncleAngleFromVegetativeStem, v, ft, d)
##    elif fieldID == kInflorescencePeduncleAngleFromVegetativeStemApicalFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].apicalStalkAngleFromVegetativeStem, v, ft, d)
##    elif fieldID == kInflorescenceFlowersSpiralOnStemFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].flowersSpiralOnStem, v, ft, d)
##    elif fieldID == kInflorescenceIsHeadFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].isHead, v, ft, d)
##    elif fieldID == kInflorescenceTerminalStalkLengthFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].terminalStalkLength_mm, v, ft, d)
##    elif fieldID == kInflorescencePeduncleLengthFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].peduncleLength_mm, v, ft, d)
##    elif fieldID == kInflorescenceInternodeLengthFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].internodeLength_mm, v, ft, d)
##    elif fieldID == kInflorescencePedicelLengthFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].pedicelLength_mm, v, ft, d)
##    elif fieldID == kInflorescenceInternodeWidthFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].internodeWidth_mm, v, ft, d)
##    elif fieldID == kInflorescencePedicelTaperIndexFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].pedicelTaperIndex, v, ft, d)
##    elif fieldID == kInflorescenceIsTerminalFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].isTerminal, v, ft, d)
##    elif fieldID == kInflorescenceBiomassRequiredFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].optimalBiomass_pctMPB, v, ft, d)
##    elif fieldID == kInflorescenceMinFractOptBiomassToCreateFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].minFractionOfOptimalBiomassToCreateInflorescence_frn, v, ft, d)
##    elif fieldID == kInflorescenceMinFractOptBiomassForFlowersFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].minFractionOfOptimalBiomassToMakeFlowers_frn, v, ft, d)
##    elif fieldID == kInflorescenceDaysToAllFlowersShowingFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].daysToAllFlowersCreated, v, ft, d)
##    elif fieldID == kInflorescenceFlowersDrawTopToBottomFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].flowersDrawTopToBottom, v, ft, d)
##    elif fieldID == kInflorescenceMinDaysToCreateInflorescenceFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].minDaysToCreateInflorescence, v, ft, d)
##    elif fieldID == kInflorescenceMaxDaysToCreateIfOverMinFractFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].maxDaysToCreateInflorescenceIfOverMinFraction, v, ft, d)
##    elif fieldID == kInflorescenceMinDaysToGrowFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].minDaysToGrow, v, ft, d)
##    elif fieldID == kInflorescenceMaxDaysToGrowFemale:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].maxDaysToGrow, v, ft, d)
##    elif fieldID == kInflorescenceFemaleBractNumBracts:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].bractTdoParams.repetitions, v, ft, d)
##    elif fieldID == kInflorescenceFemaleBractObject3D:
##        plant.transferObject3D(d, plant.pInflor[uplant.kGenderFemale].bractTdoParams.object3D, v)
##    elif fieldID == kInflorescenceFemaleBractScaleAtFullSize:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].bractTdoParams.scaleAtFullSize, v, ft, d)
##    elif fieldID == kInflorescenceFemaleBractObject3DXRotationBeforeDraw:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].bractTdoParams.xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kInflorescenceFemaleBractObject3DYRotationBeforeDraw:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].bractTdoParams.yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kInflorescenceFemaleBractObject3DZRotationBeforeDraw:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].bractTdoParams.zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kInflorescenceFemaleBractFaceColor:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].bractTdoParams.faceColor, v, ft, d)
##    elif fieldID == kInflorescenceFemaleBractBackfaceColor:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].bractTdoParams.backfaceColor, v, ft, d)
##    elif fieldID == kInflorescenceFemaleBractsAreRadiallyArranged:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].bractTdoParams.radiallyArranged, v, ft, d)
##    elif fieldID == kInflorescenceFemaleBractObject3DPullbackAngle:
##        plant.MFD(plant.pInflor[uplant.kGenderFemale].bractTdoParams.pullBackAngle, v, ft, d)
##    elif fieldID == kFruitNumSections:
##        plant.MFD(plant.pFruit.tdoParams.repetitions, v, ft, d)
##    elif fieldID == kFruitObject3D:
##        plant.transferObject3D(d, plant.pFruit.tdoParams.object3D, v)
##    elif fieldID == kFruitScaleAtFullSize:
##        plant.MFD(plant.pFruit.tdoParams.scaleAtFullSize, v, ft, d)
##    elif fieldID == kFruitObject3DXRotationBeforeDraw:
##        plant.MFD(plant.pFruit.tdoParams.xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFruitObject3DYRotationBeforeDraw:
##        plant.MFD(plant.pFruit.tdoParams.yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFruitObject3DZRotationBeforeDraw:
##        plant.MFD(plant.pFruit.tdoParams.zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFruitSectionsAreRadiallyArranged:
##        plant.MFD(plant.pFruit.tdoParams.radiallyArranged, v, ft, d)
##    elif fieldID == kFruitUnripeFaceColor:
##        plant.MFD(plant.pFruit.tdoParams.alternateFaceColor, v, ft, d)
##    elif fieldID == kFruitUnripeBackfaceColor:
##        plant.MFD(plant.pFruit.tdoParams.alternateBackfaceColor, v, ft, d)
##    elif fieldID == kFruitRipeFaceColor:
##        plant.MFD(plant.pFruit.tdoParams.faceColor, v, ft, d)
##    elif fieldID == kFruitRipeBackfaceColor:
##        plant.MFD(plant.pFruit.tdoParams.backfaceColor, v, ft, d)
##    elif fieldID == kFruitOptimumMass_pctMPB:
##        plant.MFD(plant.pFruit.optimalBiomass_pctMPB, v, ft, d)
##    elif fieldID == kFruitSCurve:
##        umath.transferSCurveValue(d, plant.pFruit.sCurveParams, index, v)
##    elif fieldID == kFruitMinDaysToGrow:
##        plant.MFD(plant.pFruit.minDaysToGrow, v, ft, d)
##    elif fieldID == kFruitMaxDaysToGrow:
##        plant.MFD(plant.pFruit.maxDaysToGrow, v, ft, d)
##    elif fieldID == kFruitDaysToRipen:
##        plant.MFD(plant.pFruit.daysToRipen, v, ft, d)
##    elif fieldID == kRootTopShowsAboveGround:
##        plant.MFD(plant.pRoot.showsAboveGround, v, ft, d)
##    elif fieldID == kRootTopObject3D:
##        plant.transferObject3D(d, plant.pRoot.tdoParams.object3D, v)
##    elif fieldID == kRootTopScaleAtFullSize:
##        plant.MFD(plant.pRoot.tdoParams.scaleAtFullSize, v, ft, d)
##    elif fieldID == kRootTopObject3DXRotationBeforeDraw:
##        plant.MFD(plant.pRoot.tdoParams.xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kRootTopObject3DYRotationBeforeDraw:
##        plant.MFD(plant.pRoot.tdoParams.yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kRootTopObject3DZRotationBeforeDraw:
##        plant.MFD(plant.pRoot.tdoParams.zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kRootTopFaceColor:
##        plant.MFD(plant.pRoot.tdoParams.faceColor, v, ft, d)
##    elif fieldID == kRootTopBackfaceColor:
##        plant.MFD(plant.pRoot.tdoParams.backfaceColor, v, ft, d)
##    elif fieldID == kStateAge:
##        plant.MFD(plant.age, v, ft, d)
##    elif fieldID == kStateBasePointX:
##        plant.MFD(plant.basePoint_mm.x, v, ft, d)
##    elif fieldID == kStateBasePointY:
##        plant.MFD(plant.basePoint_mm.y, v, ft, d)
##    elif fieldID == kStateDrawingScale:
##        plant.MFD(plant.drawingScale_PixelsPerMm, v, ft, d)
##    elif fieldID == kStateHidden:
##        plant.MFD(plant.hidden, v, ft, d)
##    elif fieldID == kStateSelected:
##        plant.MFD(plant.selectedWhenLastSaved, v, ft, d)
##    elif fieldID == kStateRotationX:
##        plant.MFD(plant.xRotation, v, ft, d)
##    elif fieldID == kStateRotationY:
##        plant.MFD(plant.yRotation, v, ft, d)
##    elif fieldID == kStateRotationZ:
##        plant.MFD(plant.zRotation, v, ft, d)
##    elif fieldID == kFlowerNumPetalsMale:
##        plant.MFD(plant.pFlower[uplant.kGenderMale].tdoParams[uplant.kFirstPetals].repetitions, v, ft, d)
##    return 0
...
##        plant.pFlower[uplant.kGenderMale].tdoParams[uplant.kBud].yRotationBeforeDraw, v = plant.MFD(plant.pFlower[uplant.kGenderMale].tdoParams[uplant.kBud].yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerMaleBudObject3DZRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderMale].tdoParams[uplant.kBud].zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerBudMaleFaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderMale].tdoParams[uplant.kBud].faceColor, v, ft, d)
##    elif fieldID == kFlowerBudMaleBackfaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderMale].tdoParams[uplant.kBud].backfaceColor, v, ft, d)
##    elif fieldID == kFlowerBudPetalsAreRadiallyArrangedMale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderMale].tdoParams[uplant.kBud].radiallyArranged, v, ft, d)
##    elif fieldID == kFlowerBudMaleObject3DPullbackAngle:
##        v = plant.MFD(plant.pFlower[uplant.kGenderMale].tdoParams[uplant.kBud].pullBackAngle, v, ft, d)
##    elif fieldID == kInflorescenceNumFlowersOnMainBranchMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].numFlowersOnMainBranch, v, ft, d)
##    elif fieldID == kInflorescenceNumFlowersPerBranchMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].numFlowersPerBranch, v, ft, d)
##    elif fieldID == kInflorescenceNumBranchesMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].numBranches, v, ft, d)
##    elif fieldID == kInflorescenceMaleStalkColor:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].stalkColor, v, ft, d)
##    elif fieldID == kInflorescenceMalePedicelColor:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].pedicelColor, v, ft, d)
##    elif fieldID == kInflorescenceBranchesAreAlternateMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].branchesAreAlternate, v, ft, d)
##    elif fieldID == kInflorescenceBranchAngleMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].branchAngle, v, ft, d)
##    elif fieldID == kInflorescenceInternodeAngleMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].angleBetweenInternodes, v, ft, d)
##    elif fieldID == kInflorescencePedicelAngleMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].pedicelAngle, v, ft, d)
##    elif fieldID == kInflorescencePeduncleAngleFromVegetativeStemMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].peduncleAngleFromVegetativeStem, v, ft, d)
##    elif fieldID == kInflorescencePeduncleAngleFromVegetativeStemApicalMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].apicalStalkAngleFromVegetativeStem, v, ft, d)
##    elif fieldID == kInflorescenceFlowersSpiralOnStemMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].flowersSpiralOnStem, v, ft, d)
##    elif fieldID == kInflorescenceIsHeadMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].isHead, v, ft, d)
##    elif fieldID == kInflorescenceTerminalStalkLengthMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].terminalStalkLength_mm, v, ft, d)
##    elif fieldID == kInflorescencePeduncleLengthMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].peduncleLength_mm, v, ft, d)
##    elif fieldID == kInflorescenceInternodeLengthMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].internodeLength_mm, v, ft, d)
##    elif fieldID == kInflorescencePedicelLengthMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].pedicelLength_mm, v, ft, d)
##    elif fieldID == kInflorescenceInternodeWidthMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].internodeWidth_mm, v, ft, d)
##    elif fieldID == kInflorescencePedicelTaperIndexMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].pedicelTaperIndex, v, ft, d)
##    elif fieldID == kInflorescenceIsTerminalMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].isTerminal, v, ft, d)
##    elif fieldID == kInflorescenceBiomassRequiredMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].optimalBiomass_pctMPB, v, ft, d)
##    elif fieldID == kInflorescenceMinFractOptBiomassToCreateMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].minFractionOfOptimalBiomassToCreateInflorescence_frn, v, ft, d)
##    elif fieldID == kInflorescenceMinFractOptBiomassForFlowersMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].minFractionOfOptimalBiomassToMakeFlowers_frn, v, ft, d)
##    elif fieldID == kInflorescenceDaysToAllFlowersShowingMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].daysToAllFlowersCreated, v, ft, d)
##    elif fieldID == kInflorescenceFlowersDrawTopToBottomMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].flowersDrawTopToBottom, v, ft, d)
##    elif fieldID == kInflorescenceMinDaysToCreateInflorescenceMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].minDaysToCreateInflorescence, v, ft, d)
##    elif fieldID == kInflorescenceMaxDaysToCreateIfOverMinFractMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].maxDaysToCreateInflorescenceIfOverMinFraction, v, ft, d)
##    elif fieldID == kInflorescenceMinDaysToGrowMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].minDaysToGrow, v, ft, d)
##    elif fieldID == kInflorescenceMaxDaysToGrowMale:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].maxDaysToGrow, v, ft, d)
##    elif fieldID == kInflorescenceMaleBractNumBracts:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].bractTdoParams.repetitions, v, ft, d)
##    elif fieldID == kInflorescenceMaleBractObject3D:
##        plant.transferObject3D(d, plant.pInflor[uplant.kGenderMale].bractTdoParams.object3D, v)
##    elif fieldID == kInflorescenceMaleBractScaleAtFullSize:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].bractTdoParams.scaleAtFullSize, v, ft, d)
##    elif fieldID == kInflorescenceMaleBractObject3DXRotationBeforeDraw:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].bractTdoParams.xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kInflorescenceMaleBractObject3DYRotationBeforeDraw:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].bractTdoParams.yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kInflorescenceMaleBractObject3DZRotationBeforeDraw:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].bractTdoParams.zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kInflorescenceMaleBractFaceColor:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].bractTdoParams.faceColor, v, ft, d)
##    elif fieldID == kInflorescenceMaleBractBackfaceColor:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].bractTdoParams.backfaceColor, v, ft, d)
##    elif fieldID == kInflorescenceMaleBractsAreRadiallyArranged:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].bractTdoParams.radiallyArranged, v, ft, d)
##    elif fieldID == kInflorescenceMaleBractObject3DPullbackAngle:
##        v = plant.MFD(plant.pInflor[uplant.kGenderMale].bractTdoParams.pullBackAngle, v, ft, d)
##    elif fieldID == kFlowerNumPistilsFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].numPistils, v, ft, d)
##    elif fieldID == kFlowerStyleLengthFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].styleLength_mm, v, ft, d)
##    elif fieldID == kFlowerStyleWidthFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].styleWidth_mm, v, ft, d)
##    elif fieldID == kFlowerStyleTaperIndexFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].styleTaperIndex, v, ft, d)
##    elif fieldID == kFlowerStigmaFemaleObject3DPullbackAngle:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kPistils].pullBackAngle, v, ft, d)
##    elif fieldID == kFlowerStyleColorFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].styleColor, v, ft, d)
##    elif fieldID == kFlowerStigmaNumSectionsFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kPistils].repetitions, v, ft, d)
##    elif fieldID == kFlowerFemaleStigmaObject3D:
##        plant.transferObject3D(d, plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kPistils].object3D, v)
##    elif fieldID == kFlowerStigmaScaleAtFullSizeFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kPistils].scaleAtFullSize, v, ft, d)
##    elif fieldID == kFlowerFemaleStigmaObject3DXRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kPistils].xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemaleStigmaObject3DYRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kPistils].yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemaleStigmaObject3DZRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kPistils].zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerStigmaFemaleFaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kPistils].faceColor, v, ft, d)
##    elif fieldID == kFlowerStigmaFemaleBackfaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kPistils].backfaceColor, v, ft, d)
##    elif fieldID == kFlowerStigmaSectionsAreRadiallyArrangedFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kPistils].radiallyArranged, v, ft, d)
##    elif fieldID == kFlowerNumStamensFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].numStamens, v, ft, d)
##    elif fieldID == kFlowerFilamentLengthFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].filamentLength_mm, v, ft, d)
##    elif fieldID == kFlowerFilamentWidthFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].filamentWidth_mm, v, ft, d)
##    elif fieldID == kFlowerFilamentTaperIndexFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].filamentTaperIndex, v, ft, d)
##    elif fieldID == kFlowerFilamentColorFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].filamentColor, v, ft, d)
##    elif fieldID == kFlowerAntherFemaleObject3DPullbackAngle:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kStamens].pullBackAngle, v, ft, d)
##    elif fieldID == kFlowerAntherNumSectionsFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kStamens].repetitions, v, ft, d)
##    elif fieldID == kFlowerFemaleAntherObject3D:
##        plant.transferObject3D(d, plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kStamens].object3D, v)
##    elif fieldID == kFlowerAntherScaleAtFullSizeFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kStamens].scaleAtFullSize, v, ft, d)
##    elif fieldID == kFlowerFemaleAntherObject3DXRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kStamens].xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemaleAntherObject3DYRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kStamens].yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemaleAntherObject3DZRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kStamens].zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerAntherFemaleFaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kStamens].faceColor, v, ft, d)
##    elif fieldID == kFlowerAntherFemaleBackfaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kStamens].backfaceColor, v, ft, d)
##    elif fieldID == kFlowerAntherSectionsAreRadiallyArrangedFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kStamens].radiallyArranged, v, ft, d)
##    elif fieldID == kFlowerPetal2NumPetalsFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSecondPetals].repetitions, v, ft, d)
##    elif fieldID == kFlowerFemalePetal2Object3D:
##        plant.transferObject3D(d, plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSecondPetals].object3D, v)
##    elif fieldID == kFlowerPetal2ScaleAtFullSizeFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSecondPetals].scaleAtFullSize, v, ft, d)
##    elif fieldID == kFlowerFemalePetal2Object3DXRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSecondPetals].xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemalePetal2Object3DYRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSecondPetals].yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemalePetal2Object3DZRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSecondPetals].zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerPetal2FemaleFaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSecondPetals].faceColor, v, ft, d)
##    elif fieldID == kFlowerPetal2FemaleBackfaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSecondPetals].backfaceColor, v, ft, d)
##    elif fieldID == kFlowerPetal2PetalsAreRadiallyArrangedFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSecondPetals].radiallyArranged, v, ft, d)
##    elif fieldID == kFlowerPetal2FemaleObject3DPullbackAngle:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSecondPetals].pullBackAngle, v, ft, d)
##    elif fieldID == kFlowerPetal3NumPetalsFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kThirdPetals].repetitions, v, ft, d)
##    elif fieldID == kFlowerFemalePetal3Object3D:
##        plant.transferObject3D(d, plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kThirdPetals].object3D, v)
##    elif fieldID == kFlowerPetal3ScaleAtFullSizeFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kThirdPetals].scaleAtFullSize, v, ft, d)
##    elif fieldID == kFlowerFemalePetal3Object3DXRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kThirdPetals].xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemalePetal3Object3DYRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kThirdPetals].yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemalePetal3Object3DZRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kThirdPetals].zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerPetal3FemaleFaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kThirdPetals].faceColor, v, ft, d)
##    elif fieldID == kFlowerPetal3FemaleBackfaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kThirdPetals].backfaceColor, v, ft, d)
##    elif fieldID == kFlowerPetal3PetalsAreRadiallyArrangedFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kThirdPetals].radiallyArranged, v, ft, d)
##    elif fieldID == kFlowerPetal3FemaleObject3DPullbackAngle:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kThirdPetals].pullBackAngle, v, ft, d)
##    elif fieldID == kFlowerPetal4NumPetalsFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFourthPetals].repetitions, v, ft, d)
##    elif fieldID == kFlowerFemalePetal4Object3D:
##        plant.transferObject3D(d, plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFourthPetals].object3D, v)
##    elif fieldID == kFlowerPetal4ScaleAtFullSizeFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFourthPetals].scaleAtFullSize, v, ft, d)
##    elif fieldID == kFlowerFemalePetal4Object3DXRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFourthPetals].xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemalePetal4Object3DYRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFourthPetals].yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemalePetal4Object3DZRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFourthPetals].zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerPetal4FemaleFaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFourthPetals].faceColor, v, ft, d)
##    elif fieldID == kFlowerPetal4FemaleBackfaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFourthPetals].backfaceColor, v, ft, d)
##    elif fieldID == kFlowerPetal4PetalsAreRadiallyArrangedFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFourthPetals].radiallyArranged, v, ft, d)
##    elif fieldID == kFlowerPetal4FemaleObject3DPullbackAngle:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFourthPetals].pullBackAngle, v, ft, d)
##    elif fieldID == kFlowerPetal5NumPetalsFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFifthPetals].repetitions, v, ft, d)
##    elif fieldID == kFlowerFemalePetal5Object3D:
##        plant.transferObject3D(d, plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFifthPetals].object3D, v)
##    elif fieldID == kFlowerPetal5ScaleAtFullSizeFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFifthPetals].scaleAtFullSize, v, ft, d)
##    elif fieldID == kFlowerFemalePetal5Object3DXRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFifthPetals].xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemalePetal5Object3DYRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFifthPetals].yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemalePetal5Object3DZRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFifthPetals].zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerPetal5FemaleFaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFifthPetals].faceColor, v, ft, d)
##    elif fieldID == kFlowerPetal5FemaleBackfaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFifthPetals].backfaceColor, v, ft, d)
##    elif fieldID == kFlowerPetal5PetalsAreRadiallyArrangedFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFifthPetals].radiallyArranged, v, ft, d)
##    elif fieldID == kFlowerPetal5FemaleObject3DPullbackAngle:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kFifthPetals].pullBackAngle, v, ft, d)
##    elif fieldID == kFlowerSepalNumPetalsFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSepals].repetitions, v, ft, d)
##    elif fieldID == kFlowerFemaleSepalObject3D:
##        plant.transferObject3D(d, plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSepals].object3D, v)
##    elif fieldID == kFlowerSepalScaleAtFullSizeFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSepals].scaleAtFullSize, v, ft, d)
##    elif fieldID == kFlowerFemaleSepalObject3DXRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSepals].xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemaleSepalObject3DYRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSepals].yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemaleSepalObject3DZRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSepals].zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerSepalFemaleFaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSepals].faceColor, v, ft, d)
##    elif fieldID == kFlowerSepalFemaleBackfaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSepals].backfaceColor, v, ft, d)
##    elif fieldID == kFlowerSepalPetalsAreRadiallyArrangedFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSepals].radiallyArranged, v, ft, d)
##    elif fieldID == kFlowerSepalFemaleObject3DPullbackAngle:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kSepals].pullBackAngle, v, ft, d)
##    elif fieldID == kFlowerFemaleBudOption:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].budDrawingOption, v, ft, d)
##    elif fieldID == kFlowerBudNumPetalsFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kBud].repetitions, v, ft, d)
##    elif fieldID == kFlowerFemaleBudObject3D:
##        plant.transferObject3D(d, plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kBud].object3D, v)
##    elif fieldID == kFlowerBudScaleAtFullSizeFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kBud].scaleAtFullSize, v, ft, d)
##    elif fieldID == kFlowerFemaleBudObject3DXRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kBud].xRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemaleBudObject3DYRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kBud].yRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerFemaleBudObject3DZRotationBeforeDraw:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kBud].zRotationBeforeDraw, v, ft, d)
##    elif fieldID == kFlowerBudFemaleFaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kBud].faceColor, v, ft, d)
##    elif fieldID == kFlowerBudFemaleBackfaceColor:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kBud].backfaceColor, v, ft, d)
##    elif fieldID == kFlowerBudPetalsAreRadiallyArrangedFemale:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kBud].radiallyArranged, v, ft, d)
##    elif fieldID == kFlowerBudFemaleObject3DPullbackAngle:
##        v = plant.MFD(plant.pFlower[uplant.kGenderFemale].tdoParams[uplant.kBud].pullBackAngle, v, ft, d)
##    return v
